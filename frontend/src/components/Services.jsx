...
const services = [
  {
    ...
    icon: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80' // Using a relevant icon here
  },
  {
    ...
    icon: 'https://images.unsplash.com/photo-1518186285589-2f7649de83e0?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80' // Using a relevant icon here
  },
  {
    ...
    icon: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80' // Using a relevant icon here
  },
  {
    ...
    icon: 'https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80' // Using a relevant icon here
  },
  {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 to-white py-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <div className="inline-block mb-6">
              <span className="px-6 py-3 bg-blue-600 text-white text-sm font-bold uppercase tracking-widest rounded-full shadow-lg">
                Strategic Consulting Excellence
              </span>
            </div>

            <h1 className="text-5xl md:text-7xl font-black text-blue-900 leading-tight mb-8">
              Transform Your
              <br />
        ...
        <div className="absolute bottom-20 right-10 w-48 h-48 bg-blue-300 rounded-full opacity-10 animate-pulse delay-1000"></div>
      </section>
                ...
                >
                  <div className={`flex flex-col lg:flex-row ${isReverse ? 'lg:flex-row-reverse' : ''}`}>
                    ...
                    <div className="lg:w-1/2 relative overflow-hidden">
                      ...
                      {/* Service Icon (replacing the number) */}
                     

                      {/* Small Service Icon (moved to bottom right) */}
                     
                    </div>

                    {/* Content Section */}
                    <div className="lg:w-1/2 p-12 lg:p-16 bg-gradient-to-br from-white to-blue-50 flex flex-col justify-center">
                      <motion.div
                      ...
                      >
                        ...
                        <h2 className="text-3xl lg:text-4xl font-black text-blue-900 leading-tight">
                          {service.title}
                        </h2>
                        ...
                        <motion.button
                          ...
                          className="inline-flex items-center px-8 py-4 bg-blue-600 text-white font-bold text-lg rounded-2xl shadow-lg hover:bg-blue-700 transition-colors duration-300"
                        >
                          Discover More
                          <motion.svg
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-12 py-5 bg-white text-blue-900 font-black text-lg rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300"
            >
