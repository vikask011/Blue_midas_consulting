  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans text-gray-900">
      <div className="container mx-auto px-6 py-20 lg:py-28 space-y-20">
        <motion.div
                ...
                >
                  ...
                  <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto font-light">
                     Data-driven strategies for forecasting, inventory optimization, and resilient supply chain design to ensure agility and cost efficiency.
                  </p>
                </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="text-gray-700 text-lg z-10 relative">
               Improve fill-rates and OTIF performance with predictive planning, multi-echelon inventory optimization, and efficient ABC-based stock policies.
              </p>
            </motion.div>
        ...
        >
          <h2 className="text-3xl font-bold mb-4">Optimize Your Supply Chain for Efficiency </h2>
          <Link
            to="/contact"
